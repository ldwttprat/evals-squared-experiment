...
Methodology, prompts, and divergence logs from the *evals²* experiment, which extends the cascade modeling first developed in [*The Research Risk Cascade: Why Even '90% Accurate' AI Tools Break Pipelines*](https://lindseydewittprat.substack.com/p/the-research-risk-cascade-why-even) (DeWitt Prat, January 2026). The experiment was presented at the [User Interviews webinar](https://www.userinterviews.com/blog/what-is-the-ai-research-risk-cascade) on 31 March 2026, and is published in [*Finding Your Blue Dot: Evaluating AI Across the Research Pipeline*](https://www.theresearchopsreview.com/p/a-blueprint-for-evaluating-ai-across-the-research-pipeline) (*ResearchOps Review*, May 2026).
